...
class TestCatalogParameters:
    ...
    def test_catalog_parameter_inheritance(self, catalog):
        ...
        sources = [
            ...
            catalog.gfs_ice_concentration(cycle="2024-06-15T18:00:00", max_lead_time=96)
        ]
    ...
    def test_parameter_types(self, catalog):
        ...
        # Both parameters
        source3 = catalog.gfs_forecast(
            cycle="2024-01-01T18:00:00",
            max_lead_time=72
        )
